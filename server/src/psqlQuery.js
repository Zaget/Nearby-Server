...
const client = new Pool({ database: 'zaget', host: 'zaget.cvjywnma6qrl.us-west-1.rds.amazonaws.com?ssl=1', user: 'dmytromarchenko1998', password: 'Tiger101998!' });

const psqlQuery = (req, res) => {
  const placeId = parseInt(req.params.id, 10);
  console.log(placeId);
  client.query(`select * from businesses where place_id = ${placeId}`, (err, data) => {
    console.log(data);
